...
function Home() {
  ...
  return (
    <>
      {/* Start Header */}
      <header className="p-4 bg-white text-black py-9 px-14">
      ...
      {/* Start Footer */}
      <footer class="text-gray-600 body-font" style={{backgroundColor: "rgba(46, 0, 64, 1)"}}>
  <div class="container px-24 py-16 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <img src={logolight} alt="logo-light" style={{width: "70px", height: "60px"}} />
      <br />
      <p class="mt-2 text-base text-slate-200">Top learning experiences that create more talent in the world.</p>
    </div>
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-400 text-sm text-sm mb-3">Product</h2>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-400 text-sm text-sm mb-3">Company</h2>
        <nav class="list-none mb-10">
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-400 text-sm mb-3">Social</h2>
        <nav class="list-none mb-10">
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-400 text-sm text-sm mb-3">Legal</h2>
        <nav class="list-none mb-10">
          <li>
  ...
  <div class="pb-11">
    <div class="container mx-auto px-24 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-400 text-base text-center sm:text-left">© 2024 NextGen UX. All rights reserved.
      </p>
